...
<div class={containerClass}>
    <div class="flex items-center space-x-2 backdrop-blur-sm bg-base-300/80 rounded-xl p-1 shadow-lg border border-base-content/10">
        ...
        >
            <span class="text-xs font-mono">{apiStore.URL.replace(/^https?:\/\//, '')}/{apiStore.VERSION}</span>
            {#if copied}
