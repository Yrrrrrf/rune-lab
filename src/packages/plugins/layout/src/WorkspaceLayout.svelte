...
>
  ...
  {#if navigationPanel}
    <aside
      ...
      style="border-opacity: 0.05; z-index: var(--rl-z-nav, 50); width: {navOpen ? "var(--rl-nav-width, 240px)" : "0px"}; left: {workspaceStrip ? "var(--rl-strip-width, 72px)" : "0px"}"
  ...
  {#if detailPanel}
    <aside
      ...
      class:border-base-content={true}
      style="border-opacity: 0.05; z-index: var(--rl-z-detail, 50); width: {detailOpen ? "var(--rl-detail-width, 320px)" : "0px"}"
