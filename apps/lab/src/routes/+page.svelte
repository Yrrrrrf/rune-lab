...
<div class="flex flex-col h-full w-full overflow-hidden">
  ...
  >
    ...
    <div
      class="border-r border-base-content/5 overflow-hidden bg-base-200/50"
    >
      <Showcase />
    </div>
