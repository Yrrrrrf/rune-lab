        ...
        <p class="text-xs opacity-50">
          {
            m.palette_status_label({
              status: shortcutStore.showPalette ? m.open_label() : m.closed_label(),
            })
          }
        </p>
      </div>
    ...
    <div class="card bg-base-200">
      <div class="card-body p-3 gap-1">
        ...
        <p class="text-xs opacity-50">
          {
            m.nav_status_label({
              status: layoutStore.navOpen ? m.open_label() : m.closed_label(),
            })
          } · {
            m.detail_status_label({
              status: layoutStore.detailOpen ? m.open_label() : m.closed_label(),
            })
          }
        </p>
      </div>
