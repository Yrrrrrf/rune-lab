    ...
    <div class="collapse-content space-y-2">
      ...
      <label class="flex items-center gap-2 text-xs">
        ...
        <span class="font-mono w-12 text-right">{
          toastDuration === 0 ? "∞" : `${toastDuration}ms`
        }</span>
      </label>
    </div>
  </details>
